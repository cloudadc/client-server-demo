...
.*Run*
----
$ java -jar target/backend-0.0.5.jar

// altertive, to run with system parameters
$ java -DAPP_DATACENTER_NAME=MP -DAPP_VERSION_NUMBER=1.1 -jar target/backend-0.0.5.jar
----
...
----
docker tag backend:latest cloudadc/backend:0.0.5
docker push cloudadc/backend:0.0.5
----
